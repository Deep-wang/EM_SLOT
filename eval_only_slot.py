...
from modeling_qwen2_slot import EMInfLogitsProcessor
...
def main():
    ...
    parser.add_argument("--use_em_inf", action="store_true", help="Use EM-INF during generation")
    parser.add_argument("--em_inf_delta", type=float, default=0.2, help="Delta for EM-INF")
    parser.add_argument("--em_inf_lr", type=float, default=1e-3, help="Learning rate for EM-INF")
    parser.add_argument("--em_inf_steps", type=int, default=10, help="Number of optimization steps for EM-INF")
    ...
    if args.use_em_inf:
        ...
        generation_params["logits_processor"] = [em_inf_processor]
    ...
    with open(log_file, "w") as f: # Use 'w' to overwrite for a new run
        ...
        f.write(f"Use EM-INF: {args.use_em_inf}\n")
        f.write(f"EM-INF Delta: {args.em_inf_delta}\n")
        f.write(f"EM-INF LR: {args.em_inf_lr}\n")
        f.write(f"EM-INF Steps: {args.em_inf_steps}\n\n")
